_base_ = [
    '../_base_/default_runtime.py', '../_base_/datasets/dacl10kexposedrebars.py'
]
...
train_pipeline = [
    ...
    dict(
        ...
        scales=[int(x * 0.1 * 896) for x in range(5, 11)],
...
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='Resize', scale=(1036, 896), keep_ratio=True),
...
train_cfg = dict(
    type='IterBasedTrainLoop', max_iters=60000, val_interval=1000)
...
work_dir = './work_dirs/dacl10k_vitl14_dinov2_exposedrebars'
